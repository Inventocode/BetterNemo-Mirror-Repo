...
(async () => {
    ...
    // 注册图标
    BN.regIcon(`<symbol id="icon-betterchat" viewBox="0 0 24 24">
        <!-- 键盘轮廓 -->
        <rect x="2" y="8" width="20" height="10" rx="1" stroke="white" stroke-width="1.2" fill="none"/>
        <!-- 鼠标 -->
        <rect x="2" y="2" width="8" height="12" rx="4" stroke="white" stroke-width="1.2" fill="none"/>
        <line x1="6" y1="2" x2="6" y2="14" stroke="white" stroke-width="1.2"/>
        <!-- 手柄 -->
        <rect x="14" y="4" width="6" height="6" rx="1" stroke="white" stroke-width="1.2" fill="none"/>
        <circle cx="17" cy="7" r="1" fill="white"/>
        <!-- 滚轮 -->
        <circle cx="6" cy="8" r="1.5" fill="white" stroke="white" stroke-width="0.5"/>
        <line x1="6" y1="5" x2="6" y2="11" stroke="white" stroke-width="0.5"/>
    </symbol>`);
