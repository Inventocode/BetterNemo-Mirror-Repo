...
.method public static request(Lcom/tencent/connect/auth/QQToken;Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)Lorg/json/JSONObject;
    ...
    :try_end_e3
    .catch Ljava/net/SocketTimeoutException; {:try_start_c7 .. :try_end_e3} :catch_167
    .catch Ljava/net/MalformedURLException; {:try_start_c7 .. :try_end_e3} :catch_154
    .catch Ljava/io/IOException; {:try_start_c7 .. :try_end_e3} :catch_13e
    .catch Lorg/json/JSONException; {:try_start_c7 .. :try_end_e3} :catch_12b
    ...
    move-result-object v1
    :try_end_ef
    .catch Ljava/net/SocketTimeoutException; {:try_start_e7 .. :try_end_ef} :catch_106
    .catch Ljava/net/MalformedURLException; {:try_start_e7 .. :try_end_ef} :catch_154
    .catch Ljava/io/IOException; {:try_start_e7 .. :try_end_ef} :catch_13e
    .catch Lorg/json/JSONException; {:try_start_e7 .. :try_end_ef} :catch_12b
    ...
    .catch Ljava/net/SocketTimeoutException; {:try_start_ef .. :try_end_f5} :catch_106
    .catch Ljava/net/MalformedURLException; {:try_start_ef .. :try_end_f5} :catch_154
    .catch Ljava/io/IOException; {:try_start_ef .. :try_end_f5} :catch_13e
    ...
    move-result v0
    :try_end_100
    .catch Ljava/net/SocketTimeoutException; {:try_start_f7 .. :try_end_100} :catch_106
    .catch Ljava/net/MalformedURLException; {:try_start_f7 .. :try_end_100} :catch_154
    .catch Ljava/io/IOException; {:try_start_f7 .. :try_end_100} :catch_13e
    .catch Lorg/json/JSONException; {:try_start_f7 .. :try_end_100} :catch_12b
    ...
    move-result-object v4
    :try_end_115
    .catch Ljava/net/SocketTimeoutException; {:try_start_111 .. :try_end_115} :catch_167
    .catch Ljava/net/MalformedURLException; {:try_start_111 .. :try_end_115} :catch_154
    .catch Ljava/io/IOException; {:try_start_111 .. :try_end_115} :catch_13e
    .catch Lorg/json/JSONException; {:try_start_111 .. :try_end_115} :catch_12b
    ...
    throw v4
    :try_end_129
    .catch Ljava/net/SocketTimeoutException; {:try_start_120 .. :try_end_129} :catch_129
    .catch Ljava/net/MalformedURLException; {:try_start_120 .. :try_end_129} :catch_154
    .catch Ljava/io/IOException; {:try_start_120 .. :try_end_129} :catch_13e
    .catch Lorg/json/JSONException; {:try_start_120 .. :try_end_129} :catch_12b
